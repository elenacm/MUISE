...
HD_PWD='C:/Users/eleni/Desktop/Master/LCSE/Practica/Practica inicial/PracticaInicial/PracticaInicial.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log div_reloj.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source div_reloj.tcl
